...
public class ClaimInsurance 
{
	...
	public void insurance() 
	{
    	...
    	System.out.println();
    	System.out.println("Insurance can be claimed if your vehicle is lost in the time period of parking it in our parking lot.");
    	System.out.println();
    	System.out.print("Enter a username to whom insurance is to be claimed: ");
